                ...
                <div className="relative">
                    ...
                    <div className="absolute right-0 top-0 h-full flex items-center gap-4">
                        ...
                        <div className="flex gap-4">
                            <button onClick={prev}>
                                <ChevronLeftIcon className="w-6 h-6 cursor-pointer hover:text-blue-500 transition-all duration-300" />
                            </button>
                            <button onClick={next}>
                                <ChevronRightIcon className="w-6 h-6 cursor-pointer hover:text-blue-500 transition-all duration-300" />
                            </button>
                        </div>
                    </div>
                </div>
                    ...
                    <div id="timelineContent" className="relative">
                        {data.map((kpi, index) => (
                            <div key={kpi.id} className="flex relative">
                                {/* Resources */}
                                <div
                                    className="w-1/4 border py-4 px-6 max-h-[183px] hover:bg-gray-100 transition-all duration-300"
                                    style={{
